...
const {createSaxParser, createXmlSaxParser, createXmlDomParser} = require('../../lib/index-cjs');
...
// test('createXmlSaxParser  ', (parser) => parser.parse(html), createXmlSaxParser({}), 10_000);
