...
test('createSaxParser *     ', (parser, html) => parser.parse(html), createSaxParser(lightHandler), 2000);
test('createXmlSaxParser *  ', (parser, html) => parser.parse(html), createXmlSaxParser(lightHandler), 2000);
test('createHtmlSaxParser * ', (parser, html) => parser.parse(html), createHtmlSaxParser(lightHandler), 2000);
test('createSaxParser       ', (parser, html) => parser.parse(html), createSaxParser(heavyHandler1), 2000);
test('createXmlSaxParser    ', (parser, html) => parser.parse(html), createXmlSaxParser(heavyHandler1), 2000);
test('createHtmlSaxParser   ', (parser, html) => parser.parse(html), createHtmlSaxParser(heavyHandler1), 2000);
...
test('createDomParser       ', (parser, html) => parser.parse(html), createDomParser(domHandler), 2000);
test('createXmlDomParser    ', (parser, html) => parser.parse(html), createXmlDomParser(domHandler), 2000);
test('createHtmlDomParser   ', (parser, html) => parser.parse(html), createHtmlDomParser(domHandler), 2000);
