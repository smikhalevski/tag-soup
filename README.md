# TagSoup 🍜 [![build](https://github.com/smikhalevski/tag-soup/actions/workflows/test.yml/badge.svg?branch=master&event=push)](https://github.com/smikhalevski/tag-soup/actions/workflows/test.yml)
